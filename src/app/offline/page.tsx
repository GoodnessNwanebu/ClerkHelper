...
export default function OfflinePage() {
  ...
  const getSpecialtyColor = (specialty: string) => {
    const colors: Record<string, string> = {
      ...
      'respiratory': 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300',
      'gastroenterology': 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-300',
      ...
      'nephrology': 'bg-cyan-100 text-cyan-700 dark:bg-cyan-900/30 dark:text-cyan-300',
      'emergency medicine': 'bg-orange-100 text-orange-700 dark:bg-orange-900/30 dark:text-orange-300',
      'pediatrics': 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-300',
      'obs & gynae': 'bg-rose-100 text-rose-700 dark:bg-rose-900/30 dark:text-rose-300'
    };
    return colors[specialty] || 'bg-slate-100 text-slate-700 dark:bg-slate-800 dark:text-slate-300';
  };
